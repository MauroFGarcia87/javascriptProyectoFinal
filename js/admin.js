...
function crearCarpa(){
    ...
    let carpaNueva = new Carpa(codigo.value, nombre.value, valorTipo, personas.value, cantidad.value, descripcion.value, url.value, precio.value);
...
const guardarCarpa = () => {
   ...
   listaCarpas[indexCarpa].precio = precio.value;
